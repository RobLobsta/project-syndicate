...
**1.** Purpose and the Central Design Rule · **2.** Structure: A Tree Plus Support Edges · **3.** Graph Construction · **4.** Strain · **5.** Detachment: The Core Algorithm · **6.** Island Conversion to Debris · **7.** Downstream Functional Consequences · **8.** Event Contract · **9.** Garage-Mode Differences · **10.** Diagnostics · **11.** Invariants
<!-- END SECTION INDEX -->
