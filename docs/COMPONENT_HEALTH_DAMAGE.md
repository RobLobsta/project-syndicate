...
**Status: PARTIAL — §7.3's `DotScheduler`, §9's `VisualDamageController` and §10's repair path are unwritten.** Everything else here is built and exercised by the suite.
