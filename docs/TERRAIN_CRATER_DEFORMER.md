...
**1.** Purpose · **2.** Data Model · **3.** The Crater Profile · **4.** The Deformation Pipeline · **5.** Collision Streaming · **6.** Rut and Scrape Deformation · **7.** Gameplay Consequences · **8.** Threading and Determinism · **9.** Surface Classification · **10.** Network Replication · **11.** Performance Budget · **12.** Invariants
<!-- END SECTION INDEX -->
...
const WORLD_SPAN_M: float = 4096.0
...
| `centre_world.x` | 22 | Quantised to `4096 m / 4 mm` |
