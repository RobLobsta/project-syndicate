...
**Status: PARTIAL — greybox and proxy stages only; no DCC assets have been promoted.** Everything else here is built and exercised by the suite.
...
**1.** Purpose and the Core Guarantee · **2.** The Three Maturity Stages · **3.** Directory Layout · **4.** Naming Conventions · **5.** DCC Export Contract · **6.** Import Configuration · **7.** Validation · **8.** The Promotion Workflow · **9.** Runtime Stage Handling · **10.** Static Volume and Ground Extension · **11.** CI Gates · **12.** Invariants
<!-- END SECTION INDEX -->
